...
class UniformSampleFrames:
    ...
    def __init__(self,
                 clip_len, # clip_len = 100 
                 num_clips=1, # num_clips = 10
                 p_interval=1,
                 seed=255,
                 **deprecated_kwargs):
        ...
        # print(" self.p_interval  self.p_interval  self.p_interval ", self.p_interval )
    ...
    def __call__(self, results):
        ...
        # print(33333333333333333333333,inds)
        inds = np.mod(inds, num_frames)
        # print(4444444444444444444444444444,inds)
        inds_org = inds.copy()
        start_index = results['start_index']
        inds = inds + start_index
        # print(555555555555555555555555555555,start_index,inds_org==inds)
...
class SampleFrames:
    ...
    def __call__(self, results):
        # print("SANPLEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEe")
