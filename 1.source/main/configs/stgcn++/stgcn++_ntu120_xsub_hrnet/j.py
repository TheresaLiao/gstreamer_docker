model = dict(
    ...
    cls_head=dict(type='GCNHead', num_classes=123, in_channels=256))

dataset_type = 'PoseDataset'
# ann_file = 'data/ntu120_hrnet.pkl'
ann_file = 'data/yolov7pose_split.pkl'
...
#         dataset=dict(type=dataset_type, ann_file=ann_file, pipeline=train_pipeline, split='xsub_train')),
#     val=dict(type=dataset_type, ann_file=ann_file, pipeline=val_pipeline, split='xsub_val'),
#     test=dict(type=dataset_type, ann_file=ann_file, pipeline=test_pipeline, split='xsub_test'))
# optimizer
