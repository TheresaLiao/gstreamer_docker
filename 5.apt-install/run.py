...
gurl1 = 'rtspsrc location=rtsp://admin:admin@10.1.1.202:554/profile1 latency=0 ! rtph264depay ! h264parse ! avdec_h264 ! cudaupload ! cudaconvert ! cudadownload ! appsink'
cap = cv2.VideoCapture(gurl1, cv2.CAP_GSTREAMER)
print(cap.isOpened())
ret, frame = cap.read()
cv2.imwrite("test_gpu.jpg", frame)
